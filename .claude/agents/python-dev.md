---
name: python-dev
description: Use PROACTIVELY for Python 3.11 + FastAPI + LangGraph Phase 5 work: runtime throttling, graceful degradation, high-risk confirmation hooks, and vector-access optimization.
